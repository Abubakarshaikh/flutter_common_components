...
class CommonSnackBar {
    ...
    switch (variant) {
      case SnackBarVariant.basic:
        defaultStyle = SnackBarStyle(
          ...
          textColor: textColor,
          actionTextColor: Platform.isIOS
  ...
  static void _showMaterialSnackBar({
    ...
    Widget? leadingIcon;
    if (style.icon != null) {
      leadingIcon = Icon(style.icon, color: style.textColor, size: 24);
    }
        ...
        children: [
          ...
          Expanded(
            child: Text(
              message,
              style:
                  style.textStyle?.copyWith(color: style.textColor) ??
                      ...
                      if (widget.action != null) ...[
                        ...
                        CupertinoButton(
                          ...
                          child: Text(
                            widget.action!.label,
                            style:
                                widget.style.actionTextStyle?.copyWith(
