...
/// Follows composition-over-inheritance principle with CommonButtonStyle
...
class CommonButton extends StatelessWidget {
    ...
    return CommonButton._(
      ...
      style:
          style?.copyWith(
            ...
            border: outlined
                ? BorderSide(color: customColor ?? Colors.grey)
                : null,
          ) ??
          CommonButtonStyle(
            backgroundColor: outlined ? Colors.transparent : Colors.grey[200],
      ...
      variant: outlined
          ? CommonButtonVariant.outlinedSecondary
  ...
  factory CommonButton.circularIcon({
    ...
    return CommonButton._(
      ...
      variant: CommonButtonVariant.circularIcon,
    );
  }
  ...
  factory CommonButton.text({
    ...
    return CommonButton._(
      ...
      variant: CommonButtonVariant.textBasic,
    );
  }
  ...
  factory CommonButton.textWithIcon({
    ...
    return CommonButton._(
      ...
      variant: CommonButtonVariant.textWithIcon,
    );
  }
  ...
  factory CommonButton.textUnderlined({
    ...
    return CommonButton._(
      ...
      variant: CommonButtonVariant.textUnderlined,
    );
  }
  ...
  factory CommonButton.textColored({
    ...
    return CommonButton._(
      ...
      variant: CommonButtonVariant.textColored,
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (variant == CommonButtonVariant.circularIcon) {
      ...
      buttonChild = Row(
        ...
        children: [
          ...
          if (isLoading)
            ...
            Text(text, style: effectiveStyle.textStyle),
  ...
  CommonButtonStyle _getEffectiveStyle(BuildContext context, bool isDisabled) {
    final theme = Theme.of(context);
    // Start with default style based on variant and platform
    CommonButtonStyle defaultStyle;
    ...
    switch (variant) {
      case CommonButtonVariant.primary:
        defaultStyle = CommonButtonStyle(
          backgroundColor: primaryColor,
          textColor: Colors.white,
          elevation: Platform.isIOS
              ? 0.0
              : 2.0, // iOS buttons don't have elevation
      ...
      case CommonButtonVariant.outlinedSecondary:
        defaultStyle = CommonButtonStyle(
          backgroundColor: variant == CommonButtonVariant.secondary
              ? (Platform.isIOS
                    ? CupertinoColors.systemGrey5
                    : Colors.grey[200])
              : Colors.transparent,
          textColor: primaryColor,
          border: variant == CommonButtonVariant.outlinedSecondary
      ...
      case CommonButtonVariant.outline:
        ...
        break;
      case CommonButtonVariant.circularIcon:
        defaultStyle = CommonButtonStyle(
        ...
        break;
      case CommonButtonVariant.textBasic:
        defaultStyle = CommonButtonStyle(
          backgroundColor: Colors.transparent,
          textColor: primaryColor,
        ...
        break;
      case CommonButtonVariant.textWithIcon:
        defaultStyle = CommonButtonStyle(
          backgroundColor: Colors.transparent,
          textColor: primaryColor,
          padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
        ...
        break;
      case CommonButtonVariant.textUnderlined:
        defaultStyle = CommonButtonStyle(
          backgroundColor: Colors.transparent,
          textColor: primaryColor,
          padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
        ...
        break;
      case CommonButtonVariant.textColored:
        defaultStyle = CommonButtonStyle(
          backgroundColor: Colors.transparent,
          textColor: primaryColor,
          padding: const EdgeInsets.symmetric(vertical: 8, horizontal: 16),
  ...
  CommonButtonStyle _mergeStyles(
    CommonButtonStyle base,
    CommonButtonStyle override,
  ) {
  ...
  Widget _buildCupertinoButton(CommonButtonStyle style, Widget child) {
    switch (variant) {
      case CommonButtonVariant.primary:
      ...
      case CommonButtonVariant.secondary:
        return CupertinoButton(
          onPressed: onPressed,
          padding: style.padding,
          color: variant == CommonButtonVariant.secondary
              ? style.backgroundColor
              : null,
          borderRadius: BorderRadius.circular(style.borderRadius ?? 8),
          child: Container(
            decoration:
                (variant == CommonButtonVariant.outlinedSecondary ||
                    variant == CommonButtonVariant.outline)
                ? BoxDecoration(
                    border: Border.all(
