...
class CommonDateTimePicker {
  ...
  static PickerStyle _getEffectiveStyle(
    ...
    final textStyle = Platform.isIOS
        ? const TextStyle(color: CupertinoColors.label, fontSize: 16)
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: Theme.of(
              context,
            ).colorScheme.copyWith(primary: style.accentColor),
          ),
          child: AlertDialog(
            title: title != null
            ...
            actions: [
              ...
              TextButton(
                ...
                style: TextButton.styleFrom(foregroundColor: style.accentColor),
      ...
      builder: (context) {
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: Theme.of(
              context,
            ).colorScheme.copyWith(primary: effectiveStyle.accentColor),
          ),
          child: AlertDialog(
            title: title != null
            ...
            actions: [
              ...
              TextButton(
                onPressed: () => Navigator.of(
                  context,
                ).pop(DateTime(selectedDate.year, selectedDate.month, 1)),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  if (title != null) Text(title, style: style.headerTextStyle),
                  CupertinoButton(
                    child: Text(
                ...
                children: [
                  ...
                  CupertinoButton(
                    child: Text(
                      ...
                      style: TextStyle(color: effectiveStyle.accentColor),
                    ),
                    onPressed: () {
                      Navigator.of(context).pop();
                    },
